...
ann.BiomodOptions <- list(
	NbCV = {{ nbcv }}, #nb of cross validation to find best size and decay parameters
	rang = {{ rang }}, #Initial random weights on [-rang, rang]
	maxit = {{ maxit }} #maximum number of iterations. Default 100
)
